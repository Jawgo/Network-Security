...
#define PORT "37168" // the port client will be connecting to 
#define S_PORT 1337
#define DEST_IP "172.19.1.14"
    ...
    for(p = servinfo; p != NULL; p = p->ai_next) {
      ...
      //  struct sockaddr_in localaddr;
       ...
       /* localaddr.sin_family = AF_INET;
        localaddr.sin_addr.s_addr = inet_addr(DEST_IP);
        localaddr.sin_port = htons(S_PORT);  // Any local port will do
